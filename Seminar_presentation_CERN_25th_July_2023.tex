...
\begin{frame}{Future prospects}
  \vspace{0.0cm}
  \begin{center}
    {\Large Key details from LHCb Upgrade I paper (arXiv:2305.10515):}
  \end{center}
  \vspace{0.3cm}
  \begin{enumerate}
    \setlength\itemsep{1.0em}
  ...
  \end{enumerate}
  \begin{center}
    \large $\gamma$ is dominated by statistical uncertainties, and will therefore benefit greatly from the new software trigger
  \end{center}
\end{frame}
